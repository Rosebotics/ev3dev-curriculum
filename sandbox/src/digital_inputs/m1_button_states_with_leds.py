...
def main():
    ...
    led_colors = [ev3.Leds.BLACK,  # This list is useful for the down button in todo4.
                  ev3.Leds.GREEN,
                  ev3.Leds.RED,
    ...
    while True:
        ...
        if btn.backspace:
            break
        time.sleep(0.01)  # Best practice to have a short delay to avoid working too hard.
